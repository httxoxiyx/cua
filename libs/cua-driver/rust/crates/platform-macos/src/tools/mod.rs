...
/// delay to every input event. Regular MCP input callers report promptly but
/// retain target-only focus protection for its original bounded window.
...
pub struct ToolState {
    ...
    /// exact, revalidated alias so host-app wrappers can continue addressing
...
pub fn register_all(
    ...
    registry.register(crate::foreground_activity::guard_tool(app_context_guarded(
    ...
    let _ = compat;
    registry.register(crate::foreground_activity::guard_tool(Box::new(
        get_screen_size::GetScreenSizeTool,
    )));
    registry.register(crate::foreground_activity::guard_tool(Box::new(
        get_desktop_state::GetDesktopStateTool,
    )));
    registry.register(crate::foreground_activity::guard_tool(Box::new(
        get_cursor_position::GetCursorPositionTool,
    )));
    registry.register(crate::foreground_activity::guard_tool(Box::new(
        move_cursor::MoveCursorTool::new(state.clone()),
    )));
    registry.register(crate::foreground_activity::guard_tool(Box::new(
        cursor_tools::SetAgentCursorEnabledTool::new(state.clone()),
    )));
    registry.register(crate::foreground_activity::guard_tool(Box::new(
        cursor_tools::SetAgentCursorMotionTool::new(state.clone()),
    )));
    registry.register(crate::foreground_activity::guard_tool(Box::new(
        cursor_tools::SetAgentCursorThemeTool::new(state.clone()),
    )));
    registry.register(crate::foreground_activity::guard_tool(Box::new(
        cursor_tools::GetAgentCursorStateTool::new(state.clone()),
    )));
    registry.register(crate::foreground_activity::guard_tool(Box::new(
        check_permissions::CheckPermissionsTool::new(state.clone()),
    )));
    ...
    registry.register(crate::foreground_activity::guard_tool(Box::new(
        get_config::GetConfigTool::new(state.clone()),
    )));
    registry.register(crate::foreground_activity::guard_tool(Box::new(
        set_config::SetConfigTool::new(state.clone()),
    )));
    registry.register(crate::foreground_activity::guard_tool(Box::new(
    ...
    registry.register(crate::foreground_activity::guard_tool(Box::new(
        cua_driver_core::page::PageTool::new(Arc::new(page::MacOsPageBackend::new(state.clone()))),
    )));
